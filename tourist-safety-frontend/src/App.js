...
function TouristAuth({ onLogin }) {
    ...
    const handleSubmit = async(e) => {
        e.preventDefault();
        const url = isLogin ? 'https://tourist-safety-monitoring-system-alpha.vercel.app/api/auth/login' : 'https://tourist-safety-monitoring-system-alpha.vercel.app/api/auth/register';
...
function AdminAuth({ onAdminLogin }) {
    ...
    const sendOtp = async(e) => {
        ...
        setLoading(true);
        try {
            const res = await fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/admin/send-otp', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const verifyOtp = async(e) => {
        ...
        setLoading(true);
        try {
            const res = await fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/admin/verify-otp', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
...
function TouristDashboard({ user, logout }) {
    ...
    useEffect(() => {
        fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/zones')
            .then(res => res.json())
            .then(backendZones => {
    ...
    const getRiskPrediction = async(lat, lng) => {
        try {
            const res = await fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/ai/risk', {
                method: 'POST',
    ...
    const sendLocationForAnomaly = async(lat, lng) => {
        try {
            const res = await fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/ai/anomaly', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'x-auth-token': token },
    ...
    useEffect(() => {
        ...
        zones.forEach(zone => {
            if (isPointInZone(currentLocation, zone.coordinates)) {
                ...
                fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/alerts', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'x-auth-token': token },
    ...
    const fetchAlerts = async() => {
        try {
            const res = await fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/alerts/my', { headers: { 'x-auth-token': token } });
    ...
    const fetchIdentity = async() => {
        try {
            const res = await fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/identity/my', { headers: { 'x-auth-token': token } });
            const data = await res.json();
            setIdentity(data);
        } catch {}
    };
    ...
    const storeIdentity = async() => {
        ...
        try {
            const res = await fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/identity/store', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'x-auth-token': token },
    ...
    const sendSOS = async() => {
        ...
        try {
            const alertRes = await fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/alerts', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'x-auth-token': token },
            ...
            await fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/notify/email', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'x-auth-token': token },
                body: JSON.stringify({
                    to: user ? user.email : '',
            ...
            const efirRes = await fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/efir/generate', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'x-auth-token': token },
                body: JSON.stringify({
            ...
            const bcRes = await fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/blockchain/store', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'x-auth-token': token },
    ...
    const translateText = async(text) => {
        ...
        try {
            const res = await fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/translate', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const sendChatMessage = async() => {
        ...
        try {
            const res = await fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/ai/chat', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'x-auth-token': token },
    ...
    return ( <
            ...
            attribution = '&copy; OSM' / > {
                ...
                zones.map((zone) => ( <
                    ...
                    } > { zone.name } < /b><br / > { zone.level === 'danger' ? 'DANGER ZONE' : 'CAUTION' } <
                    /Popup> < /
                    Polygon >
                ))
            } <
...
function AdminDashboard({ user, logout }) {
    ...
    const fetchUsers = async() => {
        try {
            const res = await fetch('https://tourist-safety-monitoring-system-alpha.vercel.app/api/admin/users', { headers: { 'x-auth-token': token } });
            const data = await res.json();
            setUsers(data);
    ...
    const fetchUserAlerts = async(userId) => {
        try {
            const res = await fetch(`https://tourist-safety-monitoring-system-alpha.vercel.app/api/admin/user-alerts/${userId}`, { headers: { 'x-auth-token': token } });
            const data = await res.json();
            setUserAlerts(data);
        } catch (err) { console.error(err); }
    };
                ...
                element = { < TouristAuth onLogin = { handleLogin }
                    ...
                    element = { < AdminAuth onAdminLogin = { handleAdminLogin }
                        ...
                        Routes >
                            ...
                            Route path = "/"
                            element = {
                                user && user.role === 'tourist' ? ( < TouristDashboard user = { user }
                                    logout = { logout }
